...
// serves our app.
//
// This machine has three React Native projects (kanban, time-tracker,
// PineTimeCompanion). On 2026-07-19 a leftover time-tracker Metro on 8081 served
// ITS bundle to this app: the Gradle build succeeded, the install succeeded, and
// the app booted showing a red screen full of time-tracker module paths. Easy to
// misread as a bug in this project. Fail loudly instead.
